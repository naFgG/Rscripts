...
def venn2(labels, names=['A', 'B'], **options):
    ...
    # legend
    draw_text(fig, ax, 0.20, 0.56, names[0], fontsize=fontsize)
    draw_text(fig, ax, 0.80, 0.56, names[1], fontsize=fontsize)
...
def venn3(labels, names=['A', 'B', 'C'], **options):
    ...
    # legend
    draw_text(fig, ax, 0.15, 0.87, names[0], fontsize=fontsize)
    draw_text(fig, ax, 0.85, 0.87, names[1], fontsize=fontsize)
    draw_text(fig, ax, 0.50, 0.02, names[2], fontsize=fontsize)
    leg = ax.legend(names, loc='best', fancybox=True)
    leg.get_frame().set_alpha(0.5)
...
def venn4(labels, names=['A', 'B', 'C', 'D'], **options):
    ...
    # legend
    draw_text(fig, ax, 0.13, 0.18, names[0],fontsize=fontsize)
    draw_text(fig, ax, 0.18, 0.83, names[1],fontsize=fontsize)
    draw_text(fig, ax, 0.82, 0.83, names[2],fontsize=fontsize)
    draw_text(fig, ax, 0.87, 0.18, names[3],fontsize=fontsize)
    leg = ax.legend(names, loc='best', fancybox=True)
    leg.get_frame().set_alpha(0.5)
...
def venn5(labels, names=['A', 'B', 'C', 'D', 'E'], **options):
    ...
    # legend
    draw_text(fig, ax, 0.02, 0.72, names[0],fontsize=fontsize)
    draw_text(fig, ax, 0.72, 0.94, names[1],fontsize=fontsize)
    draw_text(fig, ax, 0.97, 0.74, names[2],fontsize=fontsize)
    draw_text(fig, ax, 0.88, 0.05, names[3],fontsize=fontsize)
    draw_text(fig, ax, 0.12, 0.05, names[4],fontsize=fontsize)
    leg = ax.legend(names, loc='best', fancybox=True)
    leg.get_frame().set_alpha(0.5)
...
def venn6(labels, names=['A', 'B', 'C', 'D', 'E'], **options):
    ...
    # legend
    draw_text(fig, ax, 0.674, 0.824, names[0],fontsize=fontsize)
    draw_text(fig, ax, 0.747, 0.751, names[1],fontsize=fontsize)
    draw_text(fig, ax, 0.739, 0.396, names[2],fontsize=fontsize)
    draw_text(fig, ax, 0.700, 0.247, names[3],fontsize=fontsize)
    draw_text(fig, ax, 0.291, 0.255, names[4],fontsize=fontsize)
    draw_text(fig, ax, 0.203, 0.484, names[5],fontsize=fontsize)
    leg = ax.legend(names, loc='best', fancybox=True)
    leg.get_frame().set_alpha(0.5)
